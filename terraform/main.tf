...
# Application Subnet (subnet within 'VNet')
...
# >>> archly:node:agw1 >>>
# Application Gateway WAF (load_balancer)
...
# >>> archly:node:sql1 >>>
# Azure SQL Primary (database.relational) -- belongs to subnet 'Data Subnet' (see resource id 'subnet2' above; wire this resource's subnet/network args to it manually)
